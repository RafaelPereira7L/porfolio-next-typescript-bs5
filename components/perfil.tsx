    ...
    return (
        ...
        <section id="hero" className="row justify-content-center mt-5">
            ...
            <div className="col-12 text-center">
                ...
                <p className="text-center">I am 19 years old and currently I'm studying Systems Analysis and Development at the Pontifical Catholic University of Minas Gerais! 📚🙏</p>
            </div>
        </section>
        </div>
    )
